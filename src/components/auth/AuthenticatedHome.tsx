                ...
                <div className="flex flex-col items-center justify-center mt-4 px-4 w-full">
                    ...
                    {response && (
                        <div className="flex flex-col items-center w-full">
                            <Card
                                ref={cardRef}
                                className="w-full max-w-[800px] max-h-[400px] md:max-h-[460px] overflow-y-auto rounded-3xl mt-4 mb-2 border-none transition-all duration-300 shadow-lg"
                            >
                                ...
                                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 w-full max-w-[800px] justify-center">
                                    {response.isRelated ? (
                                        ...
                                        <Button
                                            variant="secondary"
                                            onClick={handleClear}
                                            className="text-base md:text-lg text-slate-700 font-semibold p-3 md:p-5 rounded-full mt-2 transition-transform duration-300 ease-in-out hover:translate-y-1 w-full sm:w-auto"
                                        >
                                            Clear
                                        </Button>
                                    )}
